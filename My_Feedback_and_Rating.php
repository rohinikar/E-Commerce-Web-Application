...
$statement = oci_parse($connection, 'SELECT f.customerid,f.feedbackid,p.pname,f.f_description,f.feedbacktime FROM Step2Shopify_Feedback f,Step2Shopify_Product p where f.productid=p.productid and f.customerid='.$userid);
...
<th width="98"> <div align="center">FEEDBACK ID </div></th>
<th width="198"> <div align="center">PRODUCT NAME </div></th>
<th width="97"> <div align="center">DESCRIPTION </div></th>
<th width="59"> <div align="center">FEEDBACK TIME </div></th>
</tr>
...
{?>	
	...
	<td><div align="center"><?=$Result["FEEDBACKID"][$i];?></div></td>
	<td><div align="center"><?=$Result["PNAME"][$i];?></div></td>
	<td><div align="center"><?=$Result["F_DESCRIPTION"][$i];?></div></td>
	<td><div align="center"><?=$Result["FEEDBACKTIME"][$i];?></div></td>
	</tr>
<?php } ?>
</table>
<br>
