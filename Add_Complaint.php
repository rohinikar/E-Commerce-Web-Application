...
<br><br><br>
<center>
<form action="Complaint_Success.php?c_id=<?PHP echo $c_id ?>" method="post">
<table >
...
<td><input type="text" name="priority" class="form-control" style="width:50%; padding:0 2%;" rows="2" placeholder="Priority"></h4></td>
</tr>
