...
$stmt=oci_parse($connection, 'UPDATE Step2Shopify_Complaints set status=2 where complaintid='.$compid);
oci_execute($stmt);
...
<th width="71"> <div align="center">CLOSE COMPLAINTS </div></th>
</tr>
...
{?>	
	...
	<td><div align="center"><a href="usercomplaintclosed.php">close complaint</a></div></td>
	</tr>
<?php } ?>
